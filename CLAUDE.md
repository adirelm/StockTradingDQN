...
> **Source of truth for requirements.** Two places, both authoritative:
...
>    lecture transcripts (`transcripts/`) into `lecturer_spec.md`, and tracked
>    item-by-item in `REQUIREMENTS.md`.
